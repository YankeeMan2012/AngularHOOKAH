...
!function (a, b, c, d) {
    var e = function (a, b) {
        ...
        return c.prototype.make = function (c) {
            ...
            b.Run.isStart() ? (e = a.options.centered ? Math.abs(e) : 0, b.Arrows.disable("prev")) : b.Run.isEnd() ? (e = Math.abs(a.options.centered ? e : 2 * e), b.Arrows.disable("next")) : (e = Math.abs(e), b.Arrows.enable()), a.track.css({
        ...
        function e() {
            this.disabled = !1, this.keyboard(), this.hoverpause(), this.bindTriggers()
        }
        ...
        return e.prototype.keyboard = function () {
            ...
            c.track.off("keyup.glide").off("mouseover.glide").off("mouseout.glide"), f.off("click.glide touchstart.glide"), a(b).off("keyup.glide").off("resize.glide." + c.uuid)
        }, new e
    }, m = function (a, b) {
        function c() {
        ...
        return d.prototype.unbind = function () {
            ...
            if(!c.Events.disabled && this.dragging) {
                ...
                var f = c.Helper.byAxis(e.pageX - this.touchStartX, e.pageY - this.touchStartY), g = 180 * this.touchSin / Math.PI;
